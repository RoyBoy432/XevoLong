...
mydf_raw <- read_csv("~/GitHub/XevoLong/data/cases_lifespan.mutants.csv")
...
avgdf_raw <- read_csv("~/GitHub/XevoLong/data/cases_lifespan.mutants_avgs.csv")
...
ance0df<-read_csv("~/GitHub/XevoLong/data/cases_anc.ANOVA_e0.csv")
